...
# date_now = pd.to_datetime('2025-06-16')
...
report_horizontal_pm(date_now, idx, report, dir_report_lab, dir_sama,
                     dir_figures, path_out)

report_vertical_pm(date_now, idx, report, dir_report_lab, dir_sama,
                   dir_figures, path_out)
